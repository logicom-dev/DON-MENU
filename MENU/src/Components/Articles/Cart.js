...
<img
src={`data:image/image/png;base64,${cartItem.imagepath}`}
alt={cartItem.LibArt}/>
<div>
...
<div className="cart-product-price"> {cartItem.prix1}
TND</div>
...
<button onClick={() =>
handleAddToCart(cartItem)}>+</button>
</div>
<div className="cart-product-total-price">
{(cartItem.prix1 * cartItem.cartQuantity).toFixed(3)}
TND
</div>
</div>
))}
